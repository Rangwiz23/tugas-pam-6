...
void editData(){
var url = Uri.parse('http://localhost/tugas pam 6/tugaspam6/update.php'); //update api calling
...
@override
void initState() {
name = TextEditingController(text: widget.list[widget.index]['name']); //setting up the values in textediting control
